...
# 📖 Porfolio on Desktop <a name="about-project"></a>

**Portfolio on desktop** is a place to show my web development projects.
...
```sh
  cd my-folder
  git clone git@github.com:ayaderaghul/portfolio-desktop.git
```
